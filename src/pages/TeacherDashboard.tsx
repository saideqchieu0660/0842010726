...
export default function TeacherDashboard() {
    ...
    try {
      ...
      if (!res.ok) {
        try {
          ...
          throw new Error(data.error || "Gặp lỗi khi tạo giáo án");
        } catch {
          throw new Error("Gặp lỗi khi tạo giáo án");
        }
      }
      ...
      try {
        ...
        throw new Error("Không thể đọc dữ liệu giáo án.");
      }
      setLessonPlanData(parsedData);
  ...
  const handleSaveLessonPlanAsDeck = async () => {
    ...
    const targetSubject = isAddToExisting
      ? "Học Phần Sẵn Có"
